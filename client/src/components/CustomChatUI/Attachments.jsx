...
const Attachments = ({ messages }) => {
    ...
    const columns = [
        ...
        { Header: "Shared On", accessor: "sharedOn" },
    ...
    return (
        <div className="flex-1 flex flex-col items-center bg-white h-full p-8 text-center">
            {attachments.length === 0
                ? (<div className='flex-1 flex flex-col items-center bg-white h-full p-8 text-center justify-center'>
