...
const Header = () => {
    ...
    const { receiver } = useSocketContext();
        ...
        <>
            <header className="px-6 py-4 bg-white border-b border-slate-100 flex justify-between items-center">
                <div className="flex items-center gap-3">
                    ...
                    <img className="rounded-full w-12 h-12" src={`https://ui-avatars.com/api/?name=${receiver.name}&background=random`} alt="" />
                    {/* </div> */}
                    <div>
                        <h2 className="text-slate-800 font-bold tracking-tight">{receiver.name}</h2>
